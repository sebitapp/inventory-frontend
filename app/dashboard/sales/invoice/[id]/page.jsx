  ...
  return (
    <div className="p-4">
      ...
      >
        ...
        <p>
          <strong>Correo:</strong> {invoice.customer_email}
        </p>
        <p>
          <strong>Telefono:</strong> {invoice.customer_phone}
        </p>
        ...
        <div className="text-right">
          ...
          <p>
            <strong>Descuento:</strong> -${invoice.discount_amount}
          </p>
          <p>
            <strong>Imp.:</strong> +${invoice.tax_amount}
          </p>

...
export default function NewInvoicePage() {
  ...
  useEffect(() => {
    ...
    searchTimeout.current = setTimeout(async () => {
      try {
        ...
        console.error("Error en bsuqueda", error);
      } finally {
        setLoading(false);
      }
    }, 400);
  ...
  async function onSubmit(data) {
    ...
    try {
      ...
      toast.success("Factura y stock actualizado correctamente!");
    ...
    <Form {...form}>
      ...
      >
        <Card>
          ...
          <CardContent className="space-y-4">
            <Label className="mb-4 text-lg text-primary">Detalles Factura</Label>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <FormField
                control={form.control}
                name="invoice_number"
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Folio.." type="" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Juan Perez" type="" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="ej@correo.com" type="" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="ej. +569 1234 5678" type="" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <Label className="mb-4 text-lg text-primary">Detalles Productos</Label>
            <div>
              <Label className="mb-2">Buscar Artículos</Label>
              <Input
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
              ...
              {loading && <p className="text-sm my-2">Buscando...</p>}
                ...
                <ScrollArea className="border rounded p-2 max-h-60 mt-2">
                  {searchResults.map((product) => (
                    <div
                      ...
                      onClick={() => handleSelectProduct(product)}
                    >
                      {product.name} - ${product.price} - {product.stock} en
                      stock
                    </div>
                  ))}
                </ScrollArea>
            ...
            {fields?.map((item, index) => (
              ...
              >
                ...
                <div>
                  <Label className="mb-2">Preio</Label>
                  <Input
                    type="number"
                    {...form.register(`products.${index}.price`, {
                      valueAsNumber: true,
            ...
            <Label className="mb-4 text-lg text-primary">Resumen</Label>
            <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
              <div className="col-span-4">
                <FormField
                  control={form.control}

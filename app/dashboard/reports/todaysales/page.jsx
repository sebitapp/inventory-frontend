...
const Page = () => {
    ...
    const buildQuery = () => {
        ...
        query.set("filters[date][$gte]", startISO);
        query.set("filters[date][$lt]", endISO);
    ...
    return <div className='py-4 md:py-6 px-4 lg:px-6'>
        <Card className="@container/card">
            <CardHeader>
                ...
                <CardDescription>
                    <span>Lista de Ventas de hoy <span className="font-bold">{new Date().toLocaleDateString()}</span> </span>
                </CardDescription>
            </CardHeader>
